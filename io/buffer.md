...
![Buffer 的分工](../snapshots/buffer-division.jpg)
...
![新构造的slab单元示例](../snapshots/new-slab-case.png)
...
![从一个新的slab单元中初次分配一个Buffer对象](../snapshots/assign-buffer-from-new-slab-case.png)
